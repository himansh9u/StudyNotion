...
const Home = () => {
    let tab = "\x02\x02\x02\x02\x02\x02";
    return (
        <div>
            {/* Section1 */}
            <div className="relative mx-auto flex flex-col w-11/12 max-w-maxContent items-center text-white justify-between">
                ...
                <div className="w-full">
                    <CodeBlocks
                        ...
                        codeblock={`<!DOCTYPE html>\n<html lang="en">\n<head>\n${tab}<title>This is myPage</title>\n</head>\n<body>\n${tab}<h1><a href="/">Header</a></h1>\n${tab}<nav>\n${tab}${tab}<a href="/one">One</a><a href="/two">Two</a>\n${tab}</nav>\n</body>\n</html>`}
                ...
                <div className="w-full">
                    <CodeBlocks
                        ...
                        heading={
                            <div className="text-4xl font-semibold w-[100%] lg:w-[40%]">
                                Start
            ...
            <div className="bg-pure-greys-5 text-richblack-700">
                <div className="homepage_bg lg:h-[320px] h-[200px]">
                    ...
                    <div className="w-11/12 max-w-maxContent flex flex-col items-center justify-between gap-5 mx-auto">
                        <div className="lg:h-[150px] h-[60px]"></div>
                ...
                <div className="mx-auto w-11/12 max-w-maxContent flex flex-col items-center justify-between gap-8">
                    ...
                    <div className="flex md:flex-row flex-col justify-between gap-7 mb-10 mt-[95px]">
            ...
            <div className="w-11/12 mx-auto my-20 max-w-maxContent flex-col items-center justify-between gap-8 bg-richblack-900 text-white">
                <InstructorSection />
                <h2 className="text-center text-4xl font-semobold mt-20 lg:mt-32">
